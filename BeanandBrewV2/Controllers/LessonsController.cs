...
namespace BeanandBrewV2.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LessonId,LessonDate")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LessonId,LessonDate")] Lesson lesson)
        {
            if (id != lesson.Id)
            {
                return NotFound();
